...
namespace MPConditions
{
    public static class NumericConditionsExtensions
    {
        ...
        /// </returns>
        [CLSCompliant(false)]
        public static NumberCondition<sbyte, sbyte> Condition(this sbyte value, string name = null)
        {
        ...
        public static NumberCondition<short, short> Condition(this short value, string name = null)
        {
        ...
        [CLSCompliant(false)]
        public static NumberCondition<ushort, ushort> Condition(this ushort value, string name = null)
        {
        ...
        public static NumberCondition<int, int> Condition(this int value, string name = null)
        {
        ...
        [CLSCompliant(false)]
        public static NumberCondition<uint, uint> Condition(this uint value, string name = null)
        {
        ...
        public static NumberCondition<long, long> Condition(this long value, string name = null)
        {
        ...
        [CLSCompliant(false)]
        public static NumberCondition<ulong, ulong> Condition(this ulong value, string name = null)
        {
        ...
        public static NumberCondition<float, float> Condition(this float value, string name = null)
        {
        ...
        public static NumberCondition<double, double> Condition(this double value, string name = null)
        {
        ...
        public static NumberCondition<decimal, decimal> Condition(this decimal value, string name = null)
        {
